# Standalone dev / test / build flake for the goodnet-link-tls
...
#
# goodnet-standalone-plugin: tls
{
  description = "GoodNet link plugin: tls — standalone plugin flake.";
    ...
    in
    {
      ...
      devShells = forAllSystems (system: pkgs: {
        default = helpers.mkPluginDevShell pkgs {
          ...
          welcomeText = ''
  goodnet-link-tls  —  standalone plugin dev shell
    ...
    nix run .#debug      — Debug build + gdb on test_tls
'';
        };
      });
